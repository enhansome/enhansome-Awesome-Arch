...
* [Auracle](https://github.com/falconindy/auracle) ⭐ 259 | 🐛 3 | 🌐 C++ | 📅 2026-09-05 (C++) - A flexible command line client for Arch Linux's User Repository.
...
* [RUA](https://github.com/vn971/rua) ⭐ 457 | 🐛 84 | 🌐 Rust | 📅 2026-04-09 (Rust) - Build tool for Arch Linux providing control, review and jailed build options.
...
* [Yay](https://github.com/Jguer/yay) ⭐ 13,752 | 🐛 213 | 🌐 Go | 📅 2026-09-17 (Go) - Yet another Yogurt, an AUR Helper written in Go.
* [Paru](https://github.com/Morganamilo/paru) ⭐ 8,985 | 🐛 204 | 🌐 Rust | 📅 2026-01-09 (Rust) - AUR helper with all needed modern wrapper features, created by a former developer of yay.
...
* [aurpublish](https://github.com/eli-schwartz/aurpublish) ⭐ 284 | 🐛 17 | 🌐 Shell | 📅 2023-12-28 - PKGBUILD management framework for the Arch User Repository.
...
* [JuNest](https://github.com/fsquillace/junest) ⭐ 2,226 | 🐛 64 | 🌐 Shell | 📅 2024-10-12 - A lightweight Arch Linux-based distro that runs, without root privileges, upon any Linux distro.
* [Dotfiles Generator](https://github.com/ulises-jeremias/dotfiles) ⭐ 134 | 🐛 23 | 🌐 QML | 📅 2026-09-17 - Dotfiles generator that allows quick configuration of different Window Managers and tools in multiple operating systems, including any Arch Linux-based distribution.
