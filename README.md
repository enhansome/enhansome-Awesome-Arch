...
* [aurpublish](https://github.com/eli-schwartz/aurpublish) ⭐ 283 | 🐛 17 | 🌐 Shell | 📅 2023-12-28 - PKGBUILD management framework for the Arch User Repository.
...
* [Dotfiles Generator](https://github.com/ulises-jeremias/dotfiles) ⭐ 134 | 🐛 25 | 🌐 QML | 📅 2026-09-14 - Dotfiles generator that allows quick configuration of different Window Managers and tools in multiple operating systems, including any Arch Linux-based distribution.
