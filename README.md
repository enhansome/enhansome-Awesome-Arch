...
* [Yay](https://github.com/Jguer/yay) ⭐ 13,712 | 🐛 209 | 🌐 Go | 📅 2026-08-22 (Go) - Yet another Yogurt, an AUR Helper written in Go.
...
* [Dotfiles Generator](https://github.com/ulises-jeremias/dotfiles) ⭐ 133 | 🐛 46 | 🌐 QML | 📅 2026-08-27 - Dotfiles generator that allows quick configuration of different Window Managers and tools in multiple operating systems, including any Arch Linux-based distribution.
