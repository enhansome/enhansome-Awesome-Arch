...
* [Yay](https://github.com/Jguer/yay) ⭐ 13,712 | 🐛 210 | 🌐 Go | 📅 2026-08-22 (Go) - Yet another Yogurt, an AUR Helper written in Go.
* [Paru](https://github.com/Morganamilo/paru) ⭐ 8,964 | 🐛 204 | 🌐 Rust | 📅 2026-01-09 (Rust) - AUR helper with all needed modern wrapper features, created by a former developer of yay.
