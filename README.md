...
* [Yay](https://github.com/Jguer/yay) ⭐ 13,724 | 🐛 209 | 🌐 Go | 📅 2026-08-22 (Go) - Yet another Yogurt, an AUR Helper written in Go.
* [Paru](https://github.com/Morganamilo/paru) ⭐ 8,969 | 🐛 204 | 🌐 Rust | 📅 2026-01-09 (Rust) - AUR helper with all needed modern wrapper features, created by a former developer of yay.
...
* [pikaur](https://github.com/actionless/pikaur) ⭐ 954 | 🐛 53 | 🌐 Python | 📅 2026-09-02 (Python) - AUR helper with minimal dependencies. Review PKGBUILDs all in once, next build them all without user interaction.
...
* [Dotfiles Generator](https://github.com/ulises-jeremias/dotfiles) ⭐ 133 | 🐛 23 | 🌐 QML | 📅 2026-09-01 - Dotfiles generator that allows quick configuration of different Window Managers and tools in multiple operating systems, including any Arch Linux-based distribution.
